...
public class Euler001Resource extends Application {
	...
	/*
	 * URI: http://localhost:8080/EulerWebService/api/euler/1 sample json payload:
	 * {"multiple1":3, "multiple2":5,"limit":10}
	 */
	...
	public Response getSimpleObject2(Euler001RequestBody Euler001ReqBody) {
		...
		if (violations.isEmpty()) {
			...
			Integer sum = Euler001SumOfMultiples.sumOfMultiples(Euler001ReqBody.getMultiple1(),
					Euler001ReqBody.getMultiple2(), Euler001ReqBody.getLimit());
			// Create response body
			Euler001ResponseBody resp = new Euler001ResponseBody(Euler001ReqBody.getMultiple1(),
					Euler001ReqBody.getMultiple2(), Euler001ReqBody.getLimit(), sum);
		...
		// One or more violation found
			...
			for (ConstraintViolation<Euler001RequestBody> violation : violations) {
				ev.add(new Euler001ValidationMessage(violation.getRootBeanClass().toString(),
